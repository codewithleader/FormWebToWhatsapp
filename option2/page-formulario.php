...
<body>
  <form action="#" method="GET" class="formulario">
    ...
    <label for="local" class="formulario__label">Selecciona tu interes:</label>

    <div class="formulario__input formulario__radio">
      <input name="interes" value="distribuidor" id="distribuidor" type="radio" />
      <label class="formulario__label" for="distribuidor">Distribuidor</label>

      <input name="interes" value="negocio" id="negocio" type="radio" />
      <label class="formulario__label" for="negocio">Negocio</label>

      <input name="interes" value="taller" id="taller" type="radio" />
      <label class="formulario__label" for="taller">Taller</label>

      <input name="interes" value="otros" id="otros" type="radio" />
      <label class="formulario__label" for="otros">Otros</label>
    </div>

    <label class="formulario__label" for="mensaje">Mensage</label>
    <textarea class="formulario__input" id="mensaje" rows="4" cols="50"></textarea>
  ...
  <script>
    document.querySelector("#submit").addEventListener("click", e => {
      ...
      const local = document.querySelector('input[name="interes"]:checked').value;
